#  Native Instruments Flair 1.1.0 (R47) - initial commit
# ---------------------------------------------------------------
fs            = require 'fs'
path          = require 'path'
...
$ = Object.assign {}, $,
  ...
  # -------------------------
  nksPresets: [
    '/Library/Application Support/Native Instruments/Flair/**/*.nksfx'
  ]
  # Ableton Live 10.1.18
  abletonRackTemplate: 'src/Flair/templates/Flair.adg.tpl'
  # Bitwig Studio 3.2.8 preset file
  bwpresetTemplate: 'src/Flair/templates/Flair.bwpreset'
