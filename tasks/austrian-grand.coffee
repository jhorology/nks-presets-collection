...
<UVI4>
    ...
    <NeededFS Source="/Library/Application Support/UVISoundBanks/Austrian Grand.ufs"/>
</UVI4>
'''
  ufs: '$Austrian Grand.ufs'
  # Ableton Live 11.0.12 Instrument Rack
  abletonRackTemplate: 'src/Austrian Grand/templates/Austrian Grand.adg.tpl'
  # Bitwig Studio 4.1.2 preset file
  bwpresetTemplate: 'src/Austrian Grand/templates/AUstrian Grand.bwpreset'
  # bank/categories
  models: [
    # Natural
    # ----------------------------
