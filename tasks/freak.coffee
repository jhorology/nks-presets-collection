#  Native Instruments Freak 1.1.0 (R47) - initial commit
# ---------------------------------------------------------------
fs            = require 'fs'
path          = require 'path'
...
$ = Object.assign {}, $,
  ...
  # -------------------------
  nksPresets: [
    '/Library/Application Support/Native Instruments/Freak/**/*.nksfx'
  ]
  # Ableton Live 10.1.18
  abletonRackTemplate: 'src/Freak/templates/Freak.adg.tpl'
  # Bitwig Studio 3.2.8 preset file
  bwpresetTemplate: 'src/Freak/templates/Freak.bwpreset'
