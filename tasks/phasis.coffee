#  Native Instruments Phasis 1.1.0 (R47) - initial commit
# ---------------------------------------------------------------
fs            = require 'fs'
path          = require 'path'
...
$ = Object.assign {}, $,
  ...
  # -------------------------
  nksPresets: [
    '/Library/Application Support/Native Instruments/Phasis/**/*.nksfx'
  ]
  # Ableton Live 10.1.18
  abletonRackTemplate: 'src/Phasis/templates/Phasis.adg.tpl'
  # Bitwig Studio 3.2.8 preset file
  bwpresetTemplate: 'src/Phasis/templates/Phasis.bwpreset'
