...
<Ableton MajorVersion="5" MinorVersion="10.0_376" SchemaChangeCount="1" Creator="Ableton Live 10.1b12" Revision="425f1bebab1137835b1d58d93225e0ac59661d62">
	<GroupDevicePreset>
			...
			<InstrumentBranchPreset Id="0">
				...
				<SourceContext>
					<BranchSourceContext Id="0">
						...
						<PresetRef />
						<BranchDeviceId Value="device:vst:instr:1968332593?n=Repro-1" />
					</BranchSourceContext>
				</SourceContext>
				<ZoneSettings>
					<KeyRange>
