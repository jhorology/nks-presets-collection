	...
	<GroupDevicePreset>
		...
		<Device>
			<DrumGroupDevice>
				...
				<IsMidiSectionVisible Value="true" />
						...
						<Device>
							<MidiPitcher>
								...
								<Pitch>
									...
									<ArrangerAutomation>
										<Events>
											<FloatEvent Time="-63072000" Value="36" />
										</Events>
									</ArrangerAutomation>
									<Manual Value="0" />
									<MidiControllerRange>
...
<% }); %>						</Buffer>
				...
				<SourceContext>
					<BranchSourceContext>
						...
						<PresetRef />
						<BranchDeviceId Value="device:vst:instr:1802662995?n=Strike" />
					</BranchSourceContext>
				</SourceContext>
				<ZoneSettings>
