...
<Ableton MajorVersion="5" MinorVersion="10.0_377" SchemaChangeCount="3" Creator="Ableton Live 10.1.2" Revision="997c60ef7459f81971120c1cb6adf87877c928c7">
	<GroupDevicePreset>
		...
		<Device>
			<InstrumentGroupDevice Id="0">
				...
				<UserName Value="Digital Synsations" />
				<Annotation Value="" />
				<SourceContext>
					<Value />
				</SourceContext>
				...
				<ViewsToRestoreWhenUnfolding Value="5" />
				<ReturnBranches />
