...
<Ableton MajorVersion="4" MinorVersion="9.5_327" Creator="Ableton Live 9.7" Revision="1cc9adc09a8a9ae50f8033410f80dffe3278d005">
	<GroupDevicePreset>
						...
						<AbletonDefaultPresetRef>
							<FileRef>
								...
								<Data>
									...
									
			...
			<InstrumentBranchPreset>
				...
				<DevicePresets>
					<VstPreset>
						...
						<ParameterCount Value="170" />
						<ProgramNumber Value="0" />
						<Buffer><% _.forEach(bufferLines, function(line) { %>
							<%=line%><% }); %>
						</Buffer>
						<Name Value="" />
						<PluginVersion Value="2020" />
						<UniqueId Value="1516859954" />
						<ByteOrder Value="2" />
						<PresetRef />
					</VstPreset>
				</DevicePresets>
				...
				<SourceContext>
					<BranchSourceContext>
						...
						<PresetRef />
						<BranchDeviceId Value="device:vst:instr:1516859954?n=iZotope%20Iris%202" />
					</BranchSourceContext>
				</SourceContext>
				<ZoneSettings>
					<KeyRange>
