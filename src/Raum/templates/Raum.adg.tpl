...
<Ableton MajorVersion="5" MinorVersion="10.0_377" SchemaChangeCount="3" Creator="Ableton Live 10.1.18" Revision="3ea63fdc488ccf762f640bd9f4c4953aab002fce">
	<GroupDevicePreset>
			...
			<AudioEffectBranchPreset Id="0">
				...
				<SourceContext>
					<BranchSourceContext Id="0">
						...
						<PresetRef />
						<BranchDeviceId Value="device:vst:audiofx:1315513425?n=Raum" />
					</BranchSourceContext>
				</SourceContext>
