	...
	<GroupDevicePreset>
		...
		<Device>
			<InstrumentGroupDevice>
				...
				<UserName Value="BassStationStereo" />
				<Annotation Value="" />
				<SourceContext>
					<Value />
				</SourceContext>
			...
			<InstrumentBranchPreset>
				...
				<DevicePresets>
					<VstPreset>
						...
						<ProgramCount Value="100" />
						<ParameterCount Value="68" />
						<ProgramNumber Value="0" />
						<Buffer><% _.forEach(bufferLines, function(line) { %>
							<%=line%><% }); %>
						</Buffer>
						<Name Value="" />
						<PluginVersion Value="2100" />
						<UniqueId Value="1316381234" />
						<ByteOrder Value="2" />
						<PresetRef />
					</VstPreset>
				</DevicePresets>
				...
				<SourceContext>
					<BranchSourceContext>
						...
						<PresetRef />
						<BranchDeviceId Value="device:vst:instr:1316381234?n=BassStationStereo" />
					</BranchSourceContext>
				</SourceContext>
				<ZoneSettings>
					<KeyRange>
